...
#include "ros_controllers/my_controller.hpp"
...
//default constructor
my_controller::my_controller() : controller_interface::ControllerInterface()
{}


//find out what this one does
rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn //var
my_controller::on_configure(const rclcpp_lifecycle::State & previous_state) //func
{
  (void) previous_state;
  ...
  for (auto joint_handle : registered_joint_handles_) 
  {
	...
	//state publisher... from robot->ros eco
...
controller_interface::controller_interface_ret_t   //fortsett her--------------
